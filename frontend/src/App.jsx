...
const defaultCv = {
  ...
  photo: "",
  personal: {
    fullName: "Greyson Libent Kanyaburugo",
    headline: "Registered Architect | Project Management Professional",
    email: "greyson.kanyaburugo@tba.go.tz",
    phone: "+255 713 348 382",
    address: "P.O. Box 31, Songea, Ruvuma, Tanzania",
    nationality: "Tanzanian",
    driving: "Class D",
    website: "",
  },
  profile:
    "Registered Architect and Project Management professional with over 16 years of progressive experience in public sector infrastructure delivery, construction supervision, contract administration, facilities management, and real estate asset oversight. Currently serving as Acting Regional Manager at Tanzania Buildings Agency (TBA), providing strategic leadership in planning, execution, and oversight of government building projects and real estate assets. Demonstrated expertise in managing multi-billion Tanzanian shilling projects, coordinating multidisciplinary teams, and ensuring compliance with regulatory and professional standards.",
  education: [
    {
      qualification: "Master of Project Management",
      institution: "Open University of Tanzania (OUT)",
      start: "2022",
      end: "2026",
    },
    {
      qualification: "Bachelor of Architecture (Hons)",
      institution: "University of Dar es Salaam",
      start: "2003",
      end: "2008",
    },
    {
      qualification: "Advanced Certificate of Secondary Education (ACSEE)",
    ...
    },
    {
      ...
      institution: "Chang’ombe Secondary School",
      start: "1996",
      end: "1999",
    },
    {
      qualification: "Primary School Certificate",
      institution: "Chang’ombe Primary School",
      start: "1988",
      end: "1995",
    },
  ],
  employment: [
    {
      ...
      company: "Tanzania Buildings Agency (TBA), Ruvuma Region",
      location: "",
      start: "2022",
      end: "Present",
      bullets: [
        "Provide overall regional leadership, strategic direction, and operational oversight aligned with TBA's mission and national development priorities.",
        "Manage and coordinate implementation of government construction and rehabilitation projects.",
        "Lead delivery of project management and consultancy services across various procurement and contract frameworks.",
        "Ensure compliance with regulatory frameworks including PPRA, NCC, AQRB, ERB, CRB, OSHA, and environmental standards.",
      ],
    },
    {
      role: "Acting Regional Manager",
      company: "Tanzania Buildings Agency (TBA), Lindi Region",
      location: "",
      start: "2021",
      end: "2022",
      bullets: [
        "Provided regional leadership and operational oversight for construction, consultancy, and facilities management services.",
        "Coordinated implementation of government construction and rehabilitation projects.",
        "Supervised contractors and technical teams to ensure quality assurance and timely project delivery.",
      ],
    },
    {
      role: "Architect I",
      company: "Tanzania Buildings Agency (TBA)",
      location: "",
      start: "2017",
      end: "2021",
      bullets: [
        "Led preparation of detailed architectural designs, working drawings, and technical specifications for public building projects.",
        "Translated concept designs into coordinated construction drawings.",
        "Conducted site inspections, technical audits, and condition assessments of existing buildings.",
      ],
    },
  ],
  skills: [
    ...
    "Excel",
    "PowerPoint",
    "Facilities Management & Maintenance Planning Systems",
    "Contract Management and Procurement Compliance",
  ],
  languages: [
    { name: "English", level: 5, proficiency: "Fluent" },
    { name: "Swahili", level: 5, proficiency: "Fluent" },
  ],
  registrations: [
    {
      title: "Registered Architect",
      body: "Architects and Quantity Surveyors Registration Board (AQRB), Tanzania",
    },
    {
      title: "Member",
      body: "Architects Association of Tanzania (AAT)",
    },
  ],
  additional:
    "Extensive experience in government building systems and asset management. Proven ability to manage multiple projects under tight deadlines.",
};
